# ref: https://github.com/facebookresearch/DrQA/blob/main/drqa/retriever/build_tfidf.py
# python build_tfidf.py ../../data/wikipedia/kilt_w100fm2__title.db ../../data/wikipedia/
