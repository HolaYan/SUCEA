# ref: https://github.com/facebookresearch/DrQA/blob/main/drqa/retriever/generate_passage_embeddings.py
# python generate_passage_embeddings.py --model_name_or_path facebook/contriever --output_dir contriever_embeddings --passages  ../corpus/text_dev.corpus.tsv --shard_id 0 --num_shards 1
